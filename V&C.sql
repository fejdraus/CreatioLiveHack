...
BEGIN
        SELECT
                @ConfigurationVersion = TextValue
        ...
        SELECT @Product = CASE
                WHEN
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name LIKE 'MarketingSoftkey%'
                        ) AND
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name LIKE 'BankOnboardingSoftkey%'
                        ) AND
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name LIKE 'BankSalesSoftkey%'
                        ) AND
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name LIKE 'Lending%'
                ...
                WHEN
                        ...
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name = 'SalesEnterprise'
                        ) AND
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name = 'ServiceEnterpriseSoftkey'
                ...
                WHEN
                        ...
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name = 'CustomerCenterSoftkey'
                ...
                WHEN
                        ...
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name = 'SalesCommerce'
                        ) AND
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name = 'CustomerCenterSoftkey'
                ...
                WHEN
                        ...
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name = 'SalesTeam'
                        ) AND
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name = 'CustomerCenterSoftkey'
                ...
                WHEN
                        EXISTS (
                                SELECT Id FROM SysPackage WHERE Name LIKE 'Studio%'
        ...
        SELECT
                @Product AS Product,
                @ConfigurationVersion AS ConfigurationVersion,
                @PrimaryCulture AS PrimaryCulture;
END